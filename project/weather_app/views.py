...
def base(request):
    ...
    context_variables = {'dates': list_of_dates, 'cities': list_of_cities}
    ...
    for d in dict_of_dates:
        ...
        for element in r['list']:
            ...
            if element['dt_txt'] in dict:
                ...
                if niz[0] == d:
                    stats = Stats(date,element['main']['temp'],element['main']['temp_max'],element['main']['temp_min'],element['main']['feels_like'],element['main']['pressure'],element['main']['humidity'],element['weather'][0]['description'])
